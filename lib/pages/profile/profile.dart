      ...
      body: ListView(
        ...
        children: [
          ...
          Card(
            ...
            child: Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text("Opções", // Título ajustado para ser mais genérico
                      style:
                          TextStyle(fontSize: 18, fontWeight: FontWeight.w600)),
                  const SizedBox(height: 12),

                  // =======================================================
                  // == BOTÃO DA CARTEIRA ADICIONADO AQUI ==
                  // =======================================================
                  ListTile(
                    ...
                    onTap: () {
                      Navigator.of(context).pushNamed(AppRoutes.walletPage);
                    },
                  ),
                  const Divider(),
                  // =======================================================
          ...
          InkWell(
            ...
            }, // Ação ao clicar (navegar para outra página)
            borderRadius: BorderRadius.circular(12.0),
            child: Card(
              shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.circular(12.0),
